...
function createEmailMessage({
  ...
  <html>
    ...
    <body>
      <h1>Hello,<br> A new student has registered for the event: Coding Hackathon.</h1>
      <div class="container">
        <h1>Details:</h1>
...
- Coding Experience: ${parsedExperience}`);
    ...
    if (allProvided) {
      fulfillmentText = `Thank you! We've received the following registration details for event: Coding Hackathon: \n
...
We will process your registration.\n`;
      ...
      if (sendGridApiKeyFromEnv && sendGridFromEmailFromEnv) {
        ...
        This message was generated by Mentora Registration Bot.` ;
        ...
        try {
          await sgMail.send({ // Removed the type assertion here
            ...emailMsg,
            from: sendGridFromEmailFromEnv as string,
          });
        ...
        fulfillmentText += ' Email notification for the registration has been sent to the event coordinator.';
      }
    } else {
